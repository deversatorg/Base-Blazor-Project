    ...
    public class HomeController : _BaseApiController
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string token)
        {
            try
            {
                ...
                var isTokenValid = await _userManager.VerifyUserTokenAsync(user, _userManager.Options.Tokens.EmailConfirmationTokenProvider, VerifyTokenPurposes.ConfirmEmail, token);
